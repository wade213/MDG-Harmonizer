...
def main_worker(gpu, ngpus_per_node, opt):
    ...
    '''set networks and dataset''' #创建dataloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='config/inpainting_celebahq.json', help='JSON file for configuration')
    ...
    parser.add_argument('--sampler', type=str, choices=['ddpm', 'ddim', 'dpm'], default='ddpm',
                        help='Sampling: ddpm (default), ddim (DDIM), dpm (DPM-Solver++)')
    parser.add_argument('--ddim-steps', type=int, default=25,
                        help='Number of DDIM/DPM sampling steps (default: 25)')
